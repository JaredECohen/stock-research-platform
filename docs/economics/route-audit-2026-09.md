...
| GET | `/api/admin/learning/preview` | none | DB-only (active items in the ticker's scopes plus their evidence; writes nothing, not even a render row) | admin | admin | admin | W7 (S18). Evaluates priors without generating a memo |
