...
| [Investment_Objectives_and_Process.md](Investment_Objectives_and_Process.md) | Jared’s September 13, 2026 objectives for high-quality compounders, potential 100-baggers and high-growth bets, plus the investment process. | Shared reference for future stock-research agents alongside `Research_State.md`; local addendum, not yet mirrored online. Saving it does not change runtime prompts, models or ratings. |
