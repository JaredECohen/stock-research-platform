...
COMPANY_PROFILES: Dict[str, Dict] = {
    ...
    "INTC": dict(
        company_name="Intel Corporation", exchange="NASDAQ",
        sector="Technology", industry="Semiconductors", sub_industry="CPU + Foundry",
        market_cap_b=95.0, revenue_b=54.0, op_margin=0.04, fcf_margin=0.02,
        growth=0.01, beta=1.05, debt_to_ebitda=3.2, shares_b=4.28, price=22.0,
        cik="0000050863", fye="December",
        description="Designs and manufactures x86 CPUs for client and data center, plus a foundry business (IFS) building out leading-edge nodes.",
        segments=["Client Computing", "Data Center & AI", "Network & Edge", "Foundry"],
        drivers=["Foundry node ramp (18A)", "AI PC refresh cycle", "Server share stabilization"],
        risks=["Foundry execution + capex burden", "Share loss to AMD/ARM", "Margin pressure"],
    ),
    "QCOM": dict(
        company_name="QUALCOMM Incorporated", exchange="NASDAQ",
        sector="Technology", industry="Semiconductors", sub_industry="Wireless + Mobile",
        market_cap_b=190.0, revenue_b=39.0, op_margin=0.28, fcf_margin=0.25,
        growth=0.09, beta=1.20, debt_to_ebitda=1.0, shares_b=1.11, price=170.0,
        cik="0000804328", fye="September",
        description="Mobile SoCs (Snapdragon), wireless modem chipsets, and a high-margin licensing business (QTL) spanning handsets, automotive, and IoT.",
        segments=["QCT (Chipsets)", "QTL (Licensing)", "Automotive", "IoT"],
        drivers=["Automotive design-win ramp", "Edge AI on-device", "Diversification beyond handsets"],
        risks=["Handset cyclicality", "Apple modem in-sourcing", "Licensing renewal risk"],
    ),
    "AAPL": dict(
